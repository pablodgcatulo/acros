...
El talento Equidad se puede expresar así: 
...
El talento Prudencia se puede expresar así: 
...
El talento Enfoque se puede expresar así: 

*Nicolás H., ejecutivo de sistemas:* "Para mí la eficiencia es muy importante. Soy la clase de persona que juega todos los hoyos de golf en dos horas y media. Cuando trabajaba en Electronic Data Systems, desarrollé una lista de preguntas que me permitiera revisar el trabajo de cada división en quince minutos. El fundador, Ross Perot, me apodaba “El Dentista” porque programaba todo un día de reuniones de quince minutos exactos".

*Benjamín E, ejecutivo de ventas:* "Siempre estoy sopesando prioridades, tratando de encontrar el camino más eficiente hacia la meta que me permita perder el menor tiempo y el menor movimiento posible. Por ejemplo, cuando recibo muchas llamadas de los clientes que necesitan que me comunique con el departamento de servicio, en lugar de procesar cada llamada a medida que llega, interrumpiendo mis prioridades del día, las agrupo en una sola al final del día".

*Miguel L., administrador:* "La gente se asombra de la manera como pongo las cosas en perspectiva y no pierdo el hilo de ninguna de ellas. Cuando otras personas se atascan y levantan sus propios obstáculos, yo salto por encima de ellas, les señalo nuevamente el camino y pongo las cosas en movimiento".

*Doris L., ama de casa:* "Soy la clase de persona que prefiere ir al grano  en las conversaciones, en el trabajo, y hasta cuando voy de compras con mi esposo. Él prefiere probarse muchas cosas y pierde mucho tiempo, mientras que yo me pruebo una sola y si me gusta y el precio es razonable la compro. Soy una compradora 'de precisión)
              }
          },
          {
            nombre:"manejar_las_fortalezas",
...
El talento Responsabilidad se puede expresar así: 
...
El talento de Competitividad se puede expresar así: 

*Augusto H. Ejecutivo de ventas:* "He sido deportista toda mi vida y digamos que no juego sólo por esparcimiento. Me gusta participar en los deportes en los que puedo vencer pero no en los que puedo perder porque, cuando pierdo, siento que la ira me consume aunque deba poner buena cara".

*Ernesto E, gerente general.* "No soy el navegante perfecto, pero me encanta la Copa Americana. Los dos barcos supuestamente deben ser idénticos y las dos tripulaciones están conformadas por deportistas de primera. Pero siempre hay un ganador. Uno de ellos tiene el as en la manga que le permite inclinar la balanza y salir vencedor con mayor frecuencia. Y eso es lo que busco: ese secreto, esa pequeñísima ventaja".

*Summer Redstone, presidente de Viacom Corporation, refiriéndose a la adquisición de la cadena de televisión CBS:* "Siempre ha sido muy importante para mí ser el número uno. Lo que vi fue que seríamos los primeros en televisión por cable. ¡Los primeros en difusión! ¡Los primeros en publicidad exterior! ¡Los primeros en programación televisada! ¡Los primeros en todo!".)
              }
          },
          {
            nombre:"manejar_las_fortalezas",
...
El talento Excelencia se puede expresar así: 
...
El talento Significación se puede expresar así: 
...
El talento Conexión se puede expresar así: 

*Nelda M., ama de casa:* "La humildad es la esencia de Conexión. Uno debe saber lo que es y lo que no es. Tengo un poco de esa sabiduría y, aunque no la tengo toda, lo poco que tengo es real. Esto no es soberbia, sino verdadera humildad. Uno está seguro de sus dones, verdaderamente seguro, pero sabe que no tiene todas las respuestas. Uno comienza a sentirse conectado con los demás porque sabe que ellos tienen la sabiduría de la cual uno carece. No es posible sentirse conectado si uno cree que lo tiene todo".
...
El talento Empatía se puede expresar así:

*Alicia J., administradora:* "Hace poco estuve en una reunión de junta directiva donde una persona presentó una idea crucial para ella y para la vida de ese grupo. Cuando terminó, nadie había escuchado su opinión, nadie le había puesto atención realmente. Fue un momento de intensa desmoralización para ella. Lo vi en su cara y no fue ella misma durante un par de días. Finalmente decidí hablarle, utilizando palabras que le ayudaran a describir lo que sentía. Le dije: 'Algo anda mal', y comenzó a hablar. Le dije, entre otras cosas: 'Realmente la comprendo. Sé cuán importante era esto para usted y veo que está alterada'. Finalmente ella pudo poner en palabras lo que sentía y me dijo: 'Usted fue el único que escuchó lo que dije y que me ha manifestado algo al respecto'

*Alberto H., administrador:* "Cuando tomamos decisiones en nuestro equipo, siempre pregunto: '¿Qué dirá fulano al respecto?' '¿Qué dirá sutano?' En otras palabras, me pongo en la posición de los demás y pienso en los argumentos desde otro punto de vista a fin de poder ser más persuasivo".

*Janet P., maestra:* "Nunca jugué baloncesto porque en mi época no era un deporte femenino, pero creo saber en qué momento cambia la atmósfera durante un partido y siento urgencia de decirle al entrenador: 'Anímelos, los está perdiendo'. La empatía también funciona en grupos grandes: uno siente a la multitud".)
              }
          },
          {
            nombre:"manejar_las_fortalezas",
...
*Margarita C,  monja benedictina:* “Me  agrada  la gente. Me relaciono fácilmente porque soy buena para adaptarme. Asumo la forma del recipiente en el cual me vierten, de manera que no me irrito con facilidad".
...
*Enrique Q., técnico:* "Recuerdo como si fuera hoy las peleas entre los niños de la escuela cuando yo tenía diez u once años. Por alguna razón, sentía la urgencia de intervenir y tratar de encontrar un común acuerdo. Yo era el pacifista".)
              }
          },
          {
            nombre:"manejar_las_fortalezas",
...
El talento Inclusión se puede expresar así: 
...
El talento Relación se puede expresar así: 

*Antonio D., piloto:* "Antes volaba con la infantería de marina y, caray, teníamos que estar seguros de la palabra 'amigo' allí. Teníamos que sentirnos tranquilos de confiar en alguien más. No sé cuántas veces puse mi vida en manos de otra persona. Volábamos ala con ala y yo podía morir si mi amigo no lograba llevarme de regreso a salvo"

*Jazmín J., empresario:* "Definitivamente escojo muy bien a mis amigos. Cuando conozco a una persona, al principio no le dedico mucho tiempo. Ella no me conoce, yo no la conozco, de manera que nos limitamos a ser amables. Pero si las circunstancias nos permiten llegar a conocernos mejor, es como si rebasara un umbral y de repente me siento dispuesta a dar más de mí. Comparto más de mí misma, me arriesgo por la otra persona, hago cosas que nos acercan un poco más, y demuestro que me interesa. Es curioso, porque no busco más amistades en mi vida. Tengo suficientes. Sin embargo, con cada persona que conozco, tan pronto rebaso el umbral, siento la urgencia de profundizar más y más. Ahora tengo diez personas trabajando para mí y puedo decir que con cada una tengo una buena amistad".
...
El talento Curiosidad se puede expresar así:

*Elena O.,  escritora:* “Desde  niña  deseaba  saberlo todo. Jugaba a hacer preguntas. '¿Cuál es mi pregunta de hoy?'. Inventaba las preguntas más extrañas y salía a buscar los libros en los que pudiera encontrar las respuestas. Muchas veces excedí mis alcances consultando libros que no entendía en lo absoluto, pero los leía porque tenían mi respuesta en alguna parte. Mis preguntas se convirtieron en mi herramienta para pasar de una información a otra".

*Juan R., ejecutivo de recursos humanos:* "Soy de las personas que piensa que la Internet es el mejor invento desde la rueda. Antes vivía frustrado, pero ahora cuando deseo saber cómo se está comportando la bolsa en determinado campo, o cuáles son las reglas de un cierto juego, o cuál es el producto interno bruto de España, o cualquier otra cosa, sencillamente enciendo el computador y comienzo a buscar hasta que encuentro lo que quiero".

*Carlos F., vendedor:* "Yo mismo me asombro de la cantidad de "basura" que guardo en mi mente y me encanta jugar Jeopardy, Trivial Pursuit y juegos parecidos. No me importa deshacerme de las cosas, siempre y cuando que sean materiales, pero detesto desperdiciar el conocimiento o las cosas aprendidas o no poder leer algo completo si lo disfruto".)
              }
          },
          {
            nombre:"manejar_las_fortalezas",
...
El talento Intelecto se puede expresar así: 
...
*Miguel P., ejecutivo de marketing:* "Es raro, pero siento la necesidad de que haya ruido a mi alrededor o de lo contrario no me puedo concentrar. Hay partes de mi cerebro que deben permanecer ocupadas; si no es así, se distrae con tantas cosas que termino no pudiendo hacer nada. Si puedo ocupar mi cerebro con la televisión o con el alboroto de mis hijos, entonces me puedo concentrar mucho mejor".
